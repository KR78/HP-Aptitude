...
}else
{
    ...
    {        
        // Assign 'label' => to 'facily_name' column from table and assign  'y' => to 'stocking level(units)' column from table
        $elements = array("label" => $row['facility_name'] , "y" => $row['stocking level(units)']);
